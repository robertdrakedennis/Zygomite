//! Per-component-type decoding: the [`parse_component`] dispatch plus every
//! `decode_*` body decoder and the formatting helpers they share.
//!
//! This is the leaf concern of the `interface` module: it is called by
//! [`super::render`] (human-readable group rendering) and mirrored by
//! [`super::deps`] (dependency extraction).
